                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <div class="btn btn-success">
                                        ...
                                        if ($keranjang = $this->cart->contents()) {
                                            ...
                                            echo "Total Belanja Anda: RM " . number_format($grand_total, 2);
                                        ?>
                                    </div>
                                    <h3 class="mt-4">Sila Letakkan Nama Anda</h3>

                                    <form action="<?= base_url('kasir/proses_pemesanan') ?>" method="post">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label class="form-label">Meja Nombor</label>
                                                    <input type="number" name="no_meja" class="form-control" placeholder="Meja Nombor" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php
                                            ...
                                            echo "<h5>Cart Anda Masih Kosong</h5>";
                                ?>
                                    <a href="<?= base_url('kasir/menu') ?>" class="btn btn-sm btn-success">Kembali</a>
                                <?php
                                        }
                                ?>
                                </div>
