                    ...
                    <div class="row">
                        ...
                        foreach ($data as $dat) : ?>
                            <div class="card mb-3 me-2" style="max-width: 540px;">
                                <div class="row g-0">
                                    <div class="col-md-5">
                                        <img src="<?= base_url('assets/img/happylemon.png') ?>" class="img-fluid rounded-start img-thumnail" alt="...">
                                    </div>
                                    <div class="col-md-7">
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $dat['nama']; ?></h5>
                                            <p class="card-text text-secondary">
                                                Position : <?= $dat['user_role']; ?><br>
                                                Status : <?= $dat['status']; ?>
                                            </p>
                                            <p class="card-text"></p>
                                            <p class="card-text"><small class="text-body-secondary">Last updated 3 mins ago</small></p>
                                            <a href="#" class="badge text-bg-primary" name="edit">Edit</a>
                                            <a href="#" class="badge text-bg-danger" name="edit">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
